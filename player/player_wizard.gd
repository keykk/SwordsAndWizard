...
@export var pikachu_skill: PackedScene
...
func attack() -> void:
	...
	if Input.is_action_just_pressed("attack"):
		...
		if !is_skill2:
			var skill2 = pikachu_skill.instantiate()
			var def = skill2.scale.x
...
func deal_damage_to_enemies() -> void:
	...
	if atk == 1:
		...
		bodies = ataque_magico_2.get_overlapping_bodies()
	else:
		return	
